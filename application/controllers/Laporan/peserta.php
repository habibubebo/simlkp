...
Class peserta extends CI_Controller{
    ...
    function index(){
        ...
        // Title 
            $pdf->text(155,50,'Data Peserta',0,0,'C');
        ...
        foreach ($data as $row){
            ...
            $pdf->Cell(12,7,'',0,0);
            $pdf->Cell(30,7,$row->Nipd,1,0,"C"); 
            $pdf->Cell(40,7,$row->Nokk,1,0,"C"); 
            $pdf->Cell(40,7,$row->Nik,1,0,"C"); 
        ...
        $pdf->Cell(13,7,'',0,0);
        $pdf->Cell(30,7,"Total Peserta : ".$total." orang",0,1);
        $pdf->Cell(13,7,'',0,0);
