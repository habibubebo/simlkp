          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><a class="btn" style="width:max-content" href="<?= base_url("index.php/presensi/peserta?Id=$tp->Idp") ?>" title="Melihat seluruh presensi <?= $tp->Nama ?>"><?= $tp->Nama ?></td>
                <td><?= $tp->Namarombel ?></td>
                <td><a class="btn" href="<?= base_url("presensi/instruktur?Id=$tp->IdI") ?>" title="Melihat presensi instruktur"><?= $tp->NamaInstruktur ?></a></td>
                <td><?= $tp->Materi ?></td>
                <td>
                  <div class="btn-group btn-group-toggle">
                    <label class="btn btn-warning btn-sm">
                    <a class="text-white" href="<?= base_url("index.php/presensi/form_ubah/$tp->Id") ?>" title="Klik untuk merubah data.">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Presensi Peserta</h5>
          ...
          <div class="row">
            <div class="form-group col-md-10" id="simple-date1">
              <div class="input-group date">
                <div class="input-group-prepend" class="btn btn-outline-secondary">
