            ...
            <form action="<?php echo base_url().'index.php/presensi/tambah'; ?>" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <select class="form-control" id="nama" aria-describedby="emailHelp"
                         name="nama" maxlength=50 required>
                    ...
                    <div class="form-group col-md-6">
                    <input type="text" class="form-control" id="jks" aria-describedby="emailHelp"
                        placeholder="Jenis Kursus" name="jks" maxlength="50" required>
                    </div>
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Materi" name="materi" maxlength="50" required>
                    </div>
                </div>
