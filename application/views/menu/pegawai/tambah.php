...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mt-4 mb-3">
  <div>
    ...
    <h1 class="h4 mb-1 font-weight-bold text-gray-800" style="font-weight:800;letter-spacing:-.02em">Tambah Pegawai</h1>
    <p class="text-muted small mb-0">Lengkapi data pegawai baru</p>
  </div>
  <ol class="breadcrumb mb-0 bg-transparent p-0 d-none d-md-flex" style="font-size:.8rem"><li class="breadcrumb-item"><a href="<?= base_url('pages/pegawai') ?>" style="color:#94a3b8;text-decoration:none">Pegawai</a></li><li class="breadcrumb-item active" aria-current="page" style="color:#334155;font-weight:600">Tambah</li></ol>
</div>
    ...
    <div class="card form-card mb-4">
      ...
      <div class="card-body p-4">
        <div class="row">
          ...
          <div class="form-group col-md-6 mb-3"><label class="field-label">Tempat Lahir <span class="text-danger">*</span></label><input type="text" class="form-control m-input" name="tl" maxlength="20" required placeholder="Kota lahir"></div>
