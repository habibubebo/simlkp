            ...
            <form action="<?php echo base_url().'index.php/lulusan/ubah'; ?>" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        placeholder="Nomor Induk" name="nipd" maxlength=20 required value="<?php echo $tp->Nipd ?>" onkeyup="GetDetail(this.value)">
                    </div>
                    <div class="form-group col-md-8">
                        <input class="form-control" id="nama" aria-describedby="emailHelp"
                         placeholder="Nama" name="nmlulusan" maxlength=50 required value="<?php echo $tp->Nama ?>">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Nilai 1" name="n1" maxlength="1" required value="<?php echo $tp->n1 ?>">
                    </div>
                    <div class="form-group col-md-3">
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Nilai 2" name="n2" maxlength="1" required value="<?php echo $tp->n2 ?>">
                    </div>
                    <div class="form-group col-md-3">
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Nilai 3" name="n3" maxlength="1" required value="<?php echo $tp->n3 ?>">
                    </div>
                    <div class="form-group col-md-3">
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Nilai 4" name="n4" maxlength="1" required value="<?php echo $tp->n4 ?>">
                    </div>
                </div>
