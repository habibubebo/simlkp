        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url() . 'index.php/peserta/ubah'; ?>" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <select class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Jenis" maxlength=50 required value="<?php echo $tp->Jeniskursus ?>">
                    ...
                    <div class="form-group col-md-6">
                        <select type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Kls" maxlength=20 required value="<?php echo $tp->Kelas ?>">
