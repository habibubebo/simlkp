...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mt-4 mb-3">
  <div>
    ...
    <h1 class="h4 mb-1 font-weight-bold text-gray-800" style="font-weight:800;letter-spacing:-.02em">Tambah Program</h1>
    <p class="text-muted small mb-0">Daftarkan program pelatihan baru</p>
  </div>
  <ol class="breadcrumb mb-0 bg-transparent p-0 d-none d-md-flex" style="font-size:.8rem"><li class="breadcrumb-item"><a href="<?= base_url('pages/rombel') ?>" style="color:#94a3b8;text-decoration:none">Program</a></li><li class="breadcrumb-item active" aria-current="page" style="color:#334155;font-weight:600">Tambah</li></ol>
</div>
<div class="row justify-content-center"><div class="col-12 col-lg-8 col-xl-7">
  <form action="<?= base_url('rombel/tambah'); ?>" method="POST">
    <div class="card form-card mb-4">
      ...
      <div class="card-body p-4">
        <div class="row">
          <div class="form-group col-md-6 mb-3"><label class="field-label">Jenis Kursus <span class="text-danger">*</span></label><input type="text" class="form-control m-input" name="nm" maxlength="30" required placeholder="Nama jenis kursus"></div>
          <div class="form-group col-md-6 mb-3"><label class="field-label">Kelas <span class="text-danger">*</span></label><input type="text" class="form-control m-input" name="kls" maxlength="50" required placeholder="Nama kelas"></div>
          <div class="form-group col-md-6 mb-3"><label class="field-label">Jumlah Peserta <span class="text-danger">*</span></label><input type="number" min="0" class="form-control m-input" name="jml" required placeholder="0"></div>
          <div class="form-group col-md-6 mb-3"><label class="field-label">Ruangan <span class="text-danger">*</span></label><input type="text" class="form-control m-input" name="rg" maxlength="20" required placeholder="Ruang kelas"></div>
        </div>
      </div>
    </div>
